...
# the robot where moves[i] represents its ith move. Valid moves are
...
class TestSolution(unittest.TestCase):
    ...
    def test_example1(self):
        self.assertTrue(self._s.judgeCircle("UD"))

    def test_example2(self):
        self.assertFalse(self._s.judgeCircle("LL"))

    def test_example3(self):
        self.assertFalse(self._s.judgeCircle("RRDD"))

    def test_example4(self):
        self.assertFalse(self._s.judgeCircle("LDRRLRUULR"))
